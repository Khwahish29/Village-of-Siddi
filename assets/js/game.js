...
class Game {
	...
	constructor(dom) {
		...
		if (!this.load()) {
			...
			this.showStory(
				`As the sun casts its warm glow upon the lush greenery of the forest, you stand amidst the vibrant landscape of the Siddi homeland. Nearby, the majestic hills stand as guardians, offering stones and minerals for construction and crafting. What lured you to this enchanted realm? Was it the ancient tales of Siddi resilience and wisdom, or the mystique of the towering banyan trees that dot the horizon? Regardless of your inspiration, you step onto this sacred soil. It's time to embark on the journey of building and nurturing your Siddi settlement.`,
				"Begin"
			);
			this.logMessage("info", "Welcome to Village of Siddis!");
			this.showPopup(
				// Defined in tutorial.js
				`Welcome to Village of Siddis! In this game, you will gather resources, welcome villagers, and construct new dwellings. To begin, utilize these buttons to gather 10 units of food and wood, enabling you to erect a tent for your initial settlers.`,
				"#gathering"
			);
		}
		setInterval(() => {
